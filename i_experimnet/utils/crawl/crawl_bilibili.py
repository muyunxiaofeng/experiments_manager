...
# 选择一个视频 ，只需要前半部分就可以啦
"?spm_id_from=333.1073.sub_channel.dynamic_video.click&vd_source=c22732234fd16d5dafc5f0b9e34289ed"
url = r'https://www.bilibili.com/video/BV1ZH4y1R7fS/'
url = r"https://www.bilibili.com/video/BV1T84y197FV/"
url = r"https://www.bilibili.com/video/BV1Dq4y1c7zn/"
"?spm_id_from=333.337.search-card.all.click&vd_source=c22732234fd16d5dafc5f0b9e34289ed"
...
with open('test-2023年11月05日-方差.mp4', mode='wb') as f:
    f.write(resp1.content)

resp2 = requests.get(url=audio_url, headers=header)

with open('test-2023年11月05日-方差.mp3', mode='wb') as f:
